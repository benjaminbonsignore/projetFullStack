...
<div class="container">
    ...
    <h1><center>Merci de bien entrer vos information</center></h1>
                    ...
                    <form role="form" action="{{ route('stripe.post') }}" method="post" class="require-validation"
                        ...
                        <div class='form-row row'>
                            <div class='col-xs-12 col-md-4 form-group cvc required'>
                                <label class='control-label'>CV</label> <input autocomplete='off'
                        ...
                        <div class='form-row row'>
                            <div class='col-md-12 error form-group hide'>
                                <div class="alert alert-danger" role="alert">Veuillez corriger les erreurs</div>
                            </div>
                        </div>
